package com.local.app.ui.custom;
...
public class LinePagerIndicatorDecoration extends RecyclerView.ItemDecoration {
    private static final String TAG = "LinePagerIndicatorDecor";
    ...
    private final float mIndicatorStartMargin = DP * 8;
    private final float mIndicatorTopMargin = DP * 6;
...
//    float totalLength = mIndicatorItemLength * itemCount;
        ...
        mIndicatorItemLength = (totalLength - (mIndicatorStartMargin * 2) - (paddingBetweenItems)) / (itemCount);
        float indicatorStartX = mIndicatorStartMargin;
